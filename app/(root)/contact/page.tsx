...
const Contact = () => {
    return(
        <section className="py-8 px-4 max-w-5xl">
            <h3 className="mb-6 font-bold text-2xl">Find me via socials.</h3>
            <div className="flex flex-col items-center">
                <div className="bg-[#282c34] rounded-md p-5 font-mono text-base leading-relaxed w-full">
                    ...
                    {data.socials.map((el,index) => (
                        <div key={index} className="flex mb-1 text-sm">
                            ...
                            <span className="text-[#e06c75] hover:underline ml-2">{el.name}</span>
                            </span>
                        </div>
                    ))}
